...
const MagnifyDemo = {
   ...
   */
  init: function() {
    this.canvas = document.getElementById('magnifyCanvas');
  ...
  generateOriginalImage: function() {
    ...
    ctx.fillText('放大镜', this.width / 2, this.height / 2 + 5);
  ...
  bindControls: function() {
    ...
    // 放大强度滑块
    const strengthSlider = document.getElementById('magnifyStrength');
    const strengthValue = document.getElementById('magnifyStrengthValue');
    if (strengthSlider) {
    ...
    // 放大镜半径滑块
    const radiusSlider = document.getElementById('magnifyRadius');
    const radiusValue = document.getElementById('magnifyRadiusValue');
    if (radiusSlider) {
...
if (typeof window !== 'undefined') {
  window.MagnifyDemo = MagnifyDemo;
}
